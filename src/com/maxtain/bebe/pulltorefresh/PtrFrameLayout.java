package com.maxtain.bebe.pulltorefresh;

import com.maxtain.bebe.R;
import com.maxtain.bebe.pulltorefresh.indicator.PtrIndicator;
...
public class PtrFrameLayout extends ViewGroup {
	...
	public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		toa = Toast.makeText(getContext(), getContext()
				.getResources().getString(R.string.bienao),
				Toast.LENGTH_SHORT);
		toa.setGravity(Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 0);
		toa.setMargin(0.0f, 0.15f);
	}
	...
	public boolean dispatchTouchEvent(MotionEvent e) {
		// Log.d("pull",
		// 		"call onRelease when user release:"
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (mDisableWhenHorizontalMove
					...
					&& (Math.abs(offsetX) > mPagingTouchSlop || Math
							.abs(offsetX) > 3 * Math.abs(offsetY))) {
	...
	final public void refreshComplete() {
		...
		if (delay <= 0) {
			...
			if (DEBUG) {
				Log.d(LOG_TAG, "performRefreshComplete after delay:" + delay);
			}
		}
	}
